...
export class CropSpeciesPlacement extends BaseEntity {
  ...
  @Field(() => Number)
  @prop(() => Number)
  public goalHarvestServings?: number;
}
...
@InputType()
export class CropSpeciesPlacementCreateInput
  implements Partial<CropSpeciesPlacement>
{
  @Field(() => String)
  name: string;
}
@InputType()
export class CropSpeciesPlacementUpdateInput
  extends CropSpeciesPlacementCreateInput
  implements Partial<CropSpeciesPlacement>
{
...
@InputType()
export class CropSpeciesPlacementFilterInput
  implements FilterQuery<CropSpeciesPlacement>
{
